...
export function Skeleton({ className = '', variant = 'rectangular', width, height }: SkeletonProps) {
  const baseClasses = 'animate-pulse bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 bg-[length:200%_100%]'
...
export function CardSkeleton() {
  return (
    <div className="glass border-primary/10 rounded-xl p-4 space-y-3">
...
export function WorkoutCardSkeleton() {
  return (
    <div className="glass border-primary/10 rounded-xl p-4">
      <div className="mb-3">
  ...
  return (
    <div className="space-y-3">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="glass border-primary/10 rounded-xl p-4 space-y-2">
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="glass border-primary/10 rounded-lg p-3">
