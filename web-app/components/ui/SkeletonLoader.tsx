...
export function Skeleton({ className = '', variant = 'rectangular', width, height }: SkeletonProps) {
  const baseClasses = 'animate-pulse bg-gradient-to-r from-[#8B5CF6]/10 via-[#8B5CF6]/5 to-[#8B5CF6]/10 bg-[length:200%_100%]'
...
export function CardSkeleton() {
  return (
    <div className="glass border-[#8B5CF6]/10 rounded-xl p-4 space-y-3">
...
export function WorkoutCardSkeleton() {
  return (
    <div className="glass border-[#8B5CF6]/10 rounded-xl p-4">
      <div className="mb-3">
  ...
  return (
    <div className="space-y-3">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="glass border-[#8B5CF6]/10 rounded-xl p-4 space-y-2">
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="glass border-[#8B5CF6]/10 rounded-lg p-3">
